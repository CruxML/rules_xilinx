...
################################################################
# This is a generated script based on design: zynq_axi
#
...
proc create_root_design { parentCell } {
   ...
   set m_axi [ create_bd_intf_port -mode Master -vlnv xilinx.com:interface:aximm_rtl:1.0 -portmaps { \
      ARADDR { physical_name m_axi_araddr direction O left 39 right 0 } \
         ARBURST { physical_name m_axi_arburst direction O left 1 right 0 } \
         ARCACHE { physical_name m_axi_arcache direction O left 3 right 0 } \
         ARID { physical_name m_axi_arid direction O left 15 right 0 } \
         ARLEN { physical_name m_axi_arlen direction O left 7 right 0 } \
         ARLOCK { physical_name m_axi_arlock direction O } \
         ARPROT { physical_name m_axi_arprot direction O left 2 right 0 } \
         ARQOS { physical_name m_axi_arqos direction O left 3 right 0 } \
         ARREADY { physical_name m_axi_arready direction I } \
         ARSIZE { physical_name m_axi_arsize direction O left 2 right 0 } \
         ARUSER { physical_name m_axi_aruser direction O left 15 right 0 } \
         ARVALID { physical_name m_axi_arvalid direction O } \
         AWADDR { physical_name m_axi_awaddr direction O left 39 right 0 } \
         AWBURST { physical_name m_axi_awburst direction O left 1 right 0 } \
         AWCACHE { physical_name m_axi_awcache direction O left 3 right 0 } \
         AWID { physical_name m_axi_awid direction O left 15 right 0 } \
         AWLEN { physical_name m_axi_awlen direction O left 7 right 0 } \
         AWLOCK { physical_name m_axi_awlock direction O } \
         AWPROT { physical_name m_axi_awprot direction O left 2 right 0 } \
         AWQOS { physical_name m_axi_awqos direction O left 3 right 0 } \
         AWREADY { physical_name m_axi_awready direction I } \
         AWSIZE { physical_name m_axi_awsize direction O left 2 right 0 } \
         AWUSER { physical_name m_axi_awuser direction O left 15 right 0 } \
         AWVALID { physical_name m_axi_awvalid direction O } \
         BID { physical_name m_axi_bid direction I left 15 right 0 } \
         BREADY { physical_name m_axi_bready direction O } \
         BRESP { physical_name m_axi_bresp direction I left 1 right 0 } \
         BVALID { physical_name m_axi_bvalid direction I } \
         RDATA { physical_name m_axi_rdata direction I left 127 right 0 } \
         RID { physical_name m_axi_rid direction I left 15 right 0 } \
         RLAST { physical_name m_axi_rlast direction I } \
         RREADY { physical_name m_axi_rready direction O } \
         RRESP { physical_name m_axi_rresp direction I left 1 right 0 } \
         RVALID { physical_name m_axi_rvalid direction I } \
         WDATA { physical_name m_axi_wdata direction O left 127 right 0 } \
         WLAST { physical_name m_axi_wlast direction O } \
         WREADY { physical_name m_axi_wready direction I } \
         WSTRB { physical_name m_axi_wstrb direction O left 15 right 0 } \
         WVALID { physical_name m_axi_wvalid direction O } \
      } \
      m_axi ]
   ...
   set_property HDL_ATTRIBUTE.LOCKED {TRUE} [get_bd_intf_ports m_axi]
   ...
   set axi_rst [ create_bd_port -dir O -from 0 -to 0 -type rst axi_rst ]
   set clk_250 [ create_bd_port -dir O -type clk clk_250 ]
   set rst_250 [ create_bd_port -dir O -from 0 -to 0 -type rst rst_250 ]
   ...
   set_property -dict [ list \
      ...
      CONFIG.PSU__CRL_APB__PL3_REF_CTRL__DIVISOR1 {47} \
   ...
   connect_bd_intf_net -intf_net zynq_ultra_ps_e_0_M_AXI_HPM0_FPD [get_bd_intf_ports m_axi] [get_bd_intf_pins zynq_ultra_ps_e_0/M_AXI_HPM0_FPD]

   # Create port connections
   connect_bd_net -net rst_ps8_0_99M1_peripheral_reset [get_bd_ports rst_250] [get_bd_pins rst_ps8_0_99M1/peripheral_reset]
   connect_bd_net -net rst_ps8_0_99M_peripheral_reset [get_bd_ports axi_rst] [get_bd_pins rst_ps8_0_99M/peripheral_reset]
   connect_bd_net -net zynq_ultra_ps_e_0_pl_clk0 [get_bd_ports axi_clk] [get_bd_pins rst_ps8_0_99M/slowest_sync_clk] [get_bd_pins zynq_ultra_ps_e_0/maxihpm0_fpd_aclk] [get_bd_pins zynq_ultra_ps_e_0/pl_clk0]
   connect_bd_net -net zynq_ultra_ps_e_0_pl_clk1 [get_bd_ports clk_250] [get_bd_pins rst_ps8_0_99M1/slowest_sync_clk] [get_bd_pins zynq_ultra_ps_e_0/pl_clk1]
   connect_bd_net -net zynq_ultra_ps_e_0_pl_resetn0 [get_bd_pins rst_ps8_0_99M/ext_reset_in] [get_bd_pins rst_ps8_0_99M1/ext_reset_in] [get_bd_pins zynq_ultra_ps_e_0/pl_resetn0]

   # Create address segments
   assign_bd_address -offset 0xA0000000 -range 0x10000000 -target_address_space [get_bd_addr_spaces zynq_ultra_ps_e_0/Data] [get_bd_addr_segs m_axi/Reg] -force
